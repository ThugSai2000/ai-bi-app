...
// * @return Map of strategies to the scores that they achieved in the final
// round
// */
// public HashMap<GeneticStrategy, Integer> executeGeneticTournamentRounds(int
// numRounds) throws IOException {
...
// // Sort the entries
// ArrayList<Map.Entry<GeneticStrategy, Integer>> sortedEntries =
// sortEntries(this.points.entrySet());
...
// // Kill the bottom 50%
// List<Map.Entry<GeneticStrategy, Integer>> merked =
// sortedEntries.subList(sortedEntries.size() / 2,
// sortedEntries.size());
...
// GeneticStrategy h = ((GeneticStrategy)
// (this.points.keySet().toArray()[j])).mutateNew();
...
// /**
// * One tournament round, where each strategy competes with each other strategy
// n
// * times
// *
...
// Game g = new Game((GeneticStrategy) strategies[i], (GeneticStrategy)
// strategies[j]);
...
// tournamentPoints.put((GeneticStrategy) strategies[i], s1PrevPts +
// gameOutcome.get(0));
// tournamentPoints.put((GeneticStrategy) strategies[j], s2PrevPts +
// gameOutcome.get(1));
// }
// }
...
// ArrayList<Map.Entry<GeneticStrategy, Integer>> sortedEntries = new
// ArrayList<>(entrySet);
